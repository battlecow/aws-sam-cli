...
class Pod(object):
    ...
    def delete(self):
        ...
        resp = kube_client.delete_namespaced_pod(
            name=self._pod_name, namespace="fleet", body=deleteOptions)
    ...
    def wait_for_logs(self, stdout=None, stderr=None):
        ...
        logs_itr = logClient.read_namespaced_pod_log(name=self._pod_name, namespace="fleet", follow=True)
